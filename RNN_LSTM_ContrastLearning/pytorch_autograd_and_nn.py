...
def initialize_three_layer_conv_part2(dtype=torch.float, device='cpu'):
    ...
    ##############################################################################
    # Replace "pass" statement with your code
    conv_w1 = nn.init.kaiming_uniform_(torch.empty(
    ...
    conv_w2 = nn.init.kaiming_uniform_(torch.empty(
...
def initialize_three_layer_conv_part4():
    ...
    model = nn.Sequential(OrderedDict([
        ...
        ('relu1', nn.ReLU()),
        ('conv2', nn.Conv2d(channel_1, channel_2,
...
class ResNet(nn.Module):
    def __init__(self, stage_args, Cin=3, block=ResidualBlock, num_classes=10):
        ...
        for i in range(len(stage_args)):
            blocks.append(ResNetStage(
                stage_args[i][0], stage_args[i][1], stage_args[i][2], stage_args[i][3], block=block))
